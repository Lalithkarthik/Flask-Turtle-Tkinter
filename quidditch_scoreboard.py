...
class Scoreboard(Turtle):
    ...
    def check_end_game(self):
        if self.r_score == 5:
            self.goto(0, 0)
            self.write(f"{self.hleft} loses to {self.hright}! The final score is {self.l_score} - {self.r_score}.", align="center", font=("Harry P", 30, "bold"))
        elif self.l_score == 5:
            self.goto(0, 0)
            self.write(f"{self.hleft} beats {self.hright}! The final score is {self.l_score} - {self.r_score}.", align="center", font=("Harry P", 30, "bold"))
